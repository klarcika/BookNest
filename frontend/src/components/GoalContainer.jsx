...
// import { fetchGoalWithBooks } from "../api/graphql";
...
const GoalContainer = () => {
    ...
    //     (async () => {
    //         try {
    //             const goalData = await fetchGoalWithBooks(userId);
    //             if (goalData) {
    //                 setGoal(goalData);
    //                 setCoach(goalData.coach ?? {});
    //                 setBooks(goalData.books || []);
    //             } else {
    //                 setGoal({});
    //                 setCoach({});
    //                 setBooks([]);
    //             }
    //         } catch (e) {
    //             console.error("GraphQL goal_with_books failed:", e);
    //             setGoal({});
    //             setCoach({});
    //             setBooks([]);
    //         }
